        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.OPN);
                    requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.GIN);
                    input.putInt   (ABECS.GIN_ACQIDX, 0);
                    requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.GIN);
                    input.putInt   (ABECS.GIN_ACQIDX, 1);
                    // requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.GIN);
                    input.putInt   (ABECS.GIN_ACQIDX, 2);
                    // requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.GIN);
                    input.putInt   (ABECS.GIN_ACQIDX, 3);
                    // requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.GIX);
                    requestList.add(input);
                    ...
                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.CKE);
                    input.putInt   (ABECS.CKE_KEY,  1);
                    ...
                    input.putInt   (ABECS.TLI_ACQIDX, 0);
                    input.putString(ABECS.TLI_TABVER, "0123456789");
                    requestList.add(input);

                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.TLR);
                    ...
                    input.putInt(ABECS.TLR_NREC, list.size());
                    StringBuilder data = new StringBuilder();
                    for (String item : list) { data.append(item); }
                    input.putString(ABECS.TLR_DATA, data.toString());
                    requestList.add(input);
                    ...
                    input = new Bundle();
                    input.putString(ABECS.CMD_ID, ABECS.TLE);
                    requestList.add(input);
                    ...
                    input.putInt   (ABECS.GCR_APPTYPREQ,  1);
